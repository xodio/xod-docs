...
Когда PR принят и объединён с `master` веткой, ваши изменения очень скоро появятся на производственном сервере.
...
В этом репозитарии нет строгих правил именования веток и сообщений фиксации. Давайте им простые и понятные названия, без фанатизма.
