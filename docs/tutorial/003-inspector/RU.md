...
Ноды обрабатывают значения с входных пинов и предпринимают какие-либо действия или выдают результат. Значения поступают на входные пины от выходов других нод через линки во время выполнения программы или определены постоянными занчениями при указании их с помощью _Инспектора (Inspector)_ при создании программы.
